...
<body class="hold-transition sidebar-mini">
                    ...
                    <form action="Pedidos.php" method="post" class="mt-5">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="contatoSolicitante">Contato do solicitante:</label>
                                    <input type="text" class="form-control" id="contatoSolicitante" name="contatoSolicitante" required>
                                </div>
                                <div class="form-group">
    ...
    async function enviarWhatsapp() {
        ...
        var contatoSolicitante = document.getElementById("contatoSolicitante").value;
        ...
        var mensagem = "Olá, um novo pedido foi gerado no seu sistema. Seguem as informações:\n" + "\n" +
            ...
            "Contato solicitante: " + contatoSolicitante + "\n" +
